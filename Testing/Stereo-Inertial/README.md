...
`run_stereo_inertial_tests.sh` contains examples of how to run tests on existing datasets.
...
`run_stereo_inertial_tests.sh` contains examples of how to run tests on manually recorded data.
